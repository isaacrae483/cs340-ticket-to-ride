...
public class Routes {
    ...
    public Routes(){
        ...
        routes.put(71, new Route(71, City.NASHVILLE, City.RALIEGH, 3, Colors.BLACK));
        ...
        routes.put(81, new Route(81, City.PITTSBURGH, City.RALIEGH, 2, Colors.RAINBOW));
        routes.put(82, new Route(82, City.ATLANTA, City.RALIEGH, 2, Colors.RAINBOW));
        routes.put(83, new Route(83, City.ATLANTA, City.RALIEGH, 2, Colors.RAINBOW));
        ...
        routes.put(93, new Route(93, City.RALIEGH, City.WASHINGTON, 2, Colors.RAINBOW));
        routes.put(94, new Route(94, City.RALIEGH, City.WASHINGTON, 2, Colors.RAINBOW));
        routes.put(95, new Route(95, City.RALIEGH, City.CHARLESTON, 2, Colors.RAINBOW));
