...
public class DrewFaceDownCardEvent extends GameEvent {

    public DrewFaceDownCardEvent(int trainCardDeckSize, Player player, List<TrainCard> faceUpCards, ID gameId) {
        super(gameId);
        this.player = player;
